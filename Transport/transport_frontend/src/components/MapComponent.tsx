...
// import { MapData } from "./MapComponent";
...
//   let isButtonDisabled = Object.values(isEditing).every((val) => val === true);
//   console.log("latitude", originCountry);
//   console.log("longitude", destinationCountry);

//   const validationHandler = (param: string) => {
//     setIsEditing((pre) => {
//       return { ...pre, [param]: true };
//     });
//   };

//   const onBlurValidationHandler = (param: string) => {
//     setIsEditing((pre) => {
//       return { ...pre, [param]: false };
//     });
//   };
...
//     let data = await fetch(`http://localhost:3000/booking`, {
//       method: "POST",
//       body: JSON.stringify(requestBody),
//     });

//     let bookingData = await data.json();
...
//         type="text"
//         value={origin}
//         onChange={() => validationHandler("origin")}
//         onBlur={() => onBlurValidationHandler("origin")}
//       />
//       <br />
//       {isEditing.origin && (
//         <small>You have already selected your origin country</small>
//       )}
//       <br />
...
//         type="text"
//         value={destination}
//         onChange={() => validationHandler("destination")}
//         onBlur={() => onBlurValidationHandler("destination")}
//       />
//       <br />
//       {isEditing.destination && (
//         <small>You have already selected your destination country</small>
//       )}
//       <br />
//       <textarea
...
//       />
//       <br />
//       <button disabled={isButtonDisabled} onClick={bookingsHandler}>
//         Get Booking
//       </button>
//     </>
//   );
